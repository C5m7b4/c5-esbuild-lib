...
import { Button, NormalButtonType } from "../src/components";
...
describe("Button tests", () => {
  ...
  test("should test normal button type", () => {
    const buttonType: NormalButtonType = "normal";
    const { container } = render(<Button label="click me" type={buttonType} />);
    const btn = container.querySelector("button") as HTMLButtonElement;
    fireEvent.mouseEnter(btn);
    expect(container).toMatchSnapshot();
  });
